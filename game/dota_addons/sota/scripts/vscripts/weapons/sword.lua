...
function WEAPONMODULE:InitializeWeapon(hero)
  ...
  WEAPON.effectName = ""
  WEAPON.shotSound = 'Hero_Juggernaut.PreAttack'
  WEAPON.shotHitSound = 'Hero_Juggernaut.Attack'
  ...
  function WEAPON:Shoot()
    ...
    if count == 0 then
      ParticleManager:ReleaseParticleIndex(ParticleManager:CreateParticle("particles/test_particle/sword_swing.vpcf", PATTACH_ABSORIGIN_FOLLOW, hero))
      count = 1
    elseif count == 1 then
      ParticleManager:ReleaseParticleIndex(ParticleManager:CreateParticle("particles/test_particle/sword_swing_2.vpcf", PATTACH_ABSORIGIN_FOLLOW, hero))
      count = 0
    end
  end
